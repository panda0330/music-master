import { Button, TextField,
    ...
    InputAdornment, Box, Dialog, DialogActions, DialogContent, DialogContentText, DialogTitle, IconButton, Modal } from "@mui/material";
import {
  DataGrid,
    ...
    <div>
      ...
      {groupedOptions.length > 0 ? (
        <Listbox {...getListboxProps()}>
          {(groupedOptions as typeof permissions).map((option, index) => (
